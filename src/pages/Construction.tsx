    ...
    <main className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 pt-20">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-primary to-luxury bg-clip-text text-transparent mb-4">
            Build Your Dreams
          </h1>
          ...
          {user?.role === 'admin' && (
            <Button 
              ...
              size="lg"
              className="bg-gradient-to-r from-primary to-luxury hover:opacity-90"
            >
        ...
        {filteredProjects.length > 0 ? (
          ...
          <Card className="text-center py-12">
            <CardContent>
              ...
              {user?.role === 'admin' && (
                <Button onClick={() => navigate('/add-construction')}>
